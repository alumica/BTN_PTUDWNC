  ...
  return (
    <div>
      ...
      <div className="h-[1024px] grid grid-cols-12 relative ">
        <div className="col-span-6 bg-primary-white border-r-2 border-primary-black">
        ...
        <div className="col-span-6 bg-primary-sunshine border-b-2 border-primary-black">
          <div className='h-full flex flex-col border-left items-center justify-center'>
        ...
        <div className="col-span-6 bg-primary-sunshine border-t-2 border-primary-black">
          <div className='h-full flex flex-col border-left items-center justify-center'>
            <img src={images.teaframe} alt='' className='object-center'/>
          </div>
        </div>
        <div className="col-span-6 bg-primary-white border-l-2 border-primary-black">
          <div className='h-full flex flex-col border-left items-center justify-center'>
            <div className='text-left'>
              <div className='font-montserrat text-xl text-primary-red mb-8'>what’s treding/トレンド</div>
